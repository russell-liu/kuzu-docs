...
The following example illustrates how to use multiple connections, which may work around transaction tests:
...
### Batch statements
We can us `-BATCH_STATEMENTS` to test a batch of query statments from a file:
